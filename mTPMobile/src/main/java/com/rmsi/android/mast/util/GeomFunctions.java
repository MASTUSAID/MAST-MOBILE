...
import com.rmsi.android.mast.util.*;
...
public class GeomFunctions
{
	...
	{
		String WKTString="";
		if(geomtype.equalsIgnoreCase(com.rmsi.android.mast.util.CommonFunctions.GEOM_POINT))
		{
		...
		else if(geomtype.equalsIgnoreCase(com.rmsi.android.mast.util.CommonFunctions.GEOM_LINE))
		{
			String WKTSubStr="";
