...
public class CommonFunctions 
{
	...
	String nmeaFileName = Environment.getExternalStorageDirectory() + "/MAST/MASTNmea_LOG.txt";
	List<LatLng> points;
	int MAP_MODE = 0;

	public static String SERVER_IP = "10.2.151.140";       //Staging

	// public static String SERVER_IP = "125.16.65.48";       //Staging
    // public static String SERVER_IP = "54.93.173.87";       //Live      

	
    // public static String SERVER_IP = "10.2.50.39:8080";   //Vaibhav
	// public static String SERVER_IP = "10.2.52.44:8080";   //Abhishek
	
    //public static String SERVER_IP = "52.57.82.27"; //live server new
	...
	//Iringa Lats
	//public static double latitude = -7.780325;public static double longitude = 35.692122;
	//Illasimba Lats
	/*public static double latitude = -7.75777103;
	public static double longitude = 35.51687543;*/

	//itagutwa Lats long
	/*public static double latitude = -7.5945;
	public static double longitude = 35.6826;*/
	
	//Kitayava Lats long
	/*	public static double latitude = -7.860000499985184;
		public static double longitude = 35.78500024998333;*/

   	// Burkina Faso
	/*public static double latitude = 12.074407499999086;
	public static double longitude = -0.7684995000117095;*/
	...
	public void gpsLog(String Tag,String nmea)
	{
		try {
	...
	{
		return new com.rmsi.android.mast.db.DBController(mContext).getNewGroupId();
	}
	...
	{
		com.rmsi.android.mast.db.DBController sqllite = new com.rmsi.android.mast.db.DBController(mContext);
		com.rmsi.android.mast.domain.User user = sqllite.getLoggedUser();
		...
		if(user!=null)
		{
			...
			{
				roleId = com.rmsi.android.mast.util.CommonFunctions.ROLE_ADJUDICATOR;
			}
	...
	// Added to scale down big images
		...
		/*public void saveMinExtent(String extent)
		{
			String min_extent = "MinExtent";
			SharedPreferences.Editor editor = getmMyPreferences().edit();
			editor.putString(min_extent, extent);
		...
		{
			String language = getmMyPreferences().getString("MinExtent", "3922385.215710891,-893741.2006165452,8677827.027890604,3350989.8465353884");
			return language;
		} */
		...
		public void saveLatLong(String lat,String lng)
		{
			...
			SharedPreferences.Editor editor = getmMyPreferences().edit();
			editor.putString(latKey, lat);
			editor.putString(longKey, lng);
			editor.commit();
		}

		public double getLat()
		{
			String lat = getmMyPreferences().getString("latitude", "0");			
		...
		{
			String lon = getmMyPreferences().getString("longitude", "0");
			longitude=Double.parseDouble(lon);
			return longitude;
		}
		
		public void savePowerOfApplication(Long optionId)
		{			
			String Key = "optionId";
			SharedPreferences.Editor editor = getmMyPreferences().edit();
			editor.putLong(Key, optionId);			
			editor.commit();
		}
		
		public long getPowerOfApplication()
		{
			long optionId=0l;
			optionId=getmMyPreferences().getLong("optionId", 0);
			return optionId;
		}
