...
//    public boolean validateByPerson(Context context, int shareTypeId, boolean isDispute, boolean showMessage,int isDisputeValues) {
//        boolean result = true;
//        String errorMessage = "";
//
////        if (getResident() < 0) {
...
//                        errorMessage = context.getResources().getString(R.string.FillRequiredFieldsOnNonPerson);
//                }
//            } else if (!GuiUtility.validateAttributesByPerson(getAttributes(), showMessage,isDisputeValues)) {
//                if (getIsNatural() == 1)
//                    errorMessage = context.getResources().getString(R.string.FillRequiredFieldsOnPerson);
//                else
//                    errorMessage = context.getResources().getString(R.string.FillRequiredFieldsOnNonPerson);
