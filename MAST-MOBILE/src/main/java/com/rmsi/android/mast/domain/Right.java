...
public class Right implements Serializable {
    ...
    private Person nonNaturalPerson;//nonNaturalPersonList
    private List<Person> nonNaturalPersonList;
...
//        this.nonNaturalPerson = nonNaturalPerson;
    ...
    public List<Person> getNonNaturalPersons() {
        return nonNaturalPersonList;
    }

    public void setNonNaturalPersons(List<Person> nonNaturalPerson) {
//        this.nonNaturalPersonList = nonNaturalPerson;
        this.nonNaturalPersonList = nonNaturalPerson;
    }
