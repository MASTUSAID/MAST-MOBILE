...
public class GeomFunctions {
	public static String getWKTfromPoints(String geomtype,
		...
		if (geomtype.equalsIgnoreCase(CommonFunctions.GEOM_POINT)) {
			...
			for (int i = 0; i < pointslist.size(); i++) {
				...
				WKTSubStr = WKTSubStr + latLng.longitude + " "
						+ latLng.latitude;
			}
	...
	public static boolean IsPointIntersectsLine(Point ptClicked,
			LineString polyline) {
	...
	public static boolean IsPointIntersectsPoint(Point ptClicked,
			Point featurePoint) {
