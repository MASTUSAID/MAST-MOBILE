...
public class AddFeaturesOptionsAdapter extends BaseExpandableListAdapter {
	...
	public AddFeaturesOptionsAdapter(List<String> parents,
			List<Object> childern, Context context) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = inflater
					.inflate(R.layout.item_expandable_group, null);
		...
		int imageResourceId = isExpanded ? R.drawable.action_collapse
				: R.drawable.action_expand;
