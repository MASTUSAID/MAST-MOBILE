...
public class ConfigureMapDisplay extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String[] mapDisplayitems = getResources().getStringArray(
				R.array.configureMapToolsitems);
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				R.layout.item_text_view, R.id.text1, mapDisplayitems);
	...
	private void openColorDialog(final String geomtype) {
		try {
			String[] mapDisplayColors = getResources().getStringArray(
					R.array.mapDisplayColors);
			...
			ListView listViewForColor = (ListView) dialog
